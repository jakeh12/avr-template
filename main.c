...
void display_init(void)
{
    ...
    display_write_instruction(0x3F);
    ...
    display_write_instruction(SSD1306_SET_COM_SCAN_NORMAL);
    display_write_instruction(SSD1306_SET_WIRING_SCHEME);
    display_write_instruction(0x12);
    display_write_instruction(SSD1306_DEFAULT_CONTRAST);
    ...
    display_write_instruction(SSD1306_CHARGE_PUMP_ON);
